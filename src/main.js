...
class Main extends Component {
  ...
  chromecastCastMedia() {
    ...
    Chromecast.castMedia(
      'https://cdn.jwplayer.com/manifests/N5kc87oZ.m3u8',
      // 'https://s3-eu-west-2.amazonaws.com/stash-archive-master-videos/master-audio/the-egyptian-lover.mp3',
      'DJ Slow',
      'https://cdn.boilerroom.tv/wp-content/uploads/2017/06/DJ-Slow-670x419.png',
      0
    );
  };
